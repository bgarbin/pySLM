...
class Network():
    def __init__(self,window_res_x=1920,window_res_y=1080, unit_type='gaussian',shape='square',x0=0,y0=0,theta=0,nb_x=2,nb_y=1,distance=1):
    ...
    def modify_list_centers(self):
        ...
        list_centers_x = (self.list_centers_init[0]-center[0]) * self.params['distance'] + center[0]
        list_centers_y = (self.list_centers_init[1]-center[1]) * self.params['distance'] + center[1]
...
class MainWindow(TemplateBaseClass,Network):
    ...
    def create_param_tree(self):  
        ...
        param = 'distance'
        tree_widget_item = pg.TreeWidgetItem([param])
        self.create_slider_tree(param,0,500,1,tree_widget_item,conv_factor=100)
